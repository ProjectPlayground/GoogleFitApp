...
public class CaloriesGraphMonth extends Fragment {
    LineChart caloriesChart;
    List<Entry> dataCalories=new ArrayList<>();
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.calories_graph,container,false);
        caloriesChart=(LineChart)view.findViewById(R.id.chart);
        caloriesChart.setNoDataText("Please wait.Loading your Chart.");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        new InsertAndVerifyCaloriesDataTask().execute();
    }
    ...
    private  class InsertAndVerifyCaloriesDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            YAxis yAxis=caloriesChart.getAxisRight();
            yAxis.setEnabled(false);
            caloriesChart.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM);
            caloriesChart.getXAxis().setValueFormatter(formatter);
            caloriesChart.getXAxis().setGranularity(1);
            caloriesChart.setVisibleXRangeMaximum(5);
            if(dataCalories.size()>0){
                caloriesChart.invalidate();
            }else{
                caloriesChart.setTouchEnabled(false);
                caloriesChart.setNoDataText("No Chart Data Available");
            }
